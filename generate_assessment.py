...
def generate_assessment_docs(session_id, summary, recommendations, findings):
    ...
    # Save outputs
    docx_out = os.path.join(OUTPUT_DIR, session_id, f"IT_Current_Status_Assessment_Report_{session_id}.docx")
    pptx_out = os.path.join(OUTPUT_DIR, session_id, f"IT_Current_Status_Executive_Report_{session_id}.pptx")
